...
|---|---|---|---|
| [colab_finetune.py](../notebooks/scripts/colab_finetune.py) | `ft_embs.npz` | 0.8893 | yes |
| [colab_finetune2.py](../notebooks/scripts/colab_finetune2.py) | `ft_embs2.npz` | 0.9225 | yes |
| [colab_finetune4.py](../notebooks/scripts/colab_finetune4.py) | `ft_embs4.npz` | 0.9165 | yes (helps the blend) |
| [colab_finetune3.py](../notebooks/scripts/colab_finetune3.py) | `ft_embs3.npz` | diverged, fp32 fix | no |
| [colab_finetune5.py](../notebooks/scripts/colab_finetune5.py) | `ft_embs5.npz` | curriculum variant | no |
| [colab_rerank.py](../notebooks/scripts/colab_rerank.py) | `ce_scores.npz` | round-3 cross-encoder, superseded | no |
| [colab_rerank2.py](../notebooks/scripts/colab_rerank2.py) | `ce2_scores.npz` | 0.9169 → 0.9578 holdout | no |
| [colab_rerank2_export.py](../notebooks/scripts/colab_rerank2_export.py) | `ce2_scores.npz` | stage-2-only rerun | no — but it produced the committed `ce2_scores.npz` |
